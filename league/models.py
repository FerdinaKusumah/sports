...
class Tournament(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    home = models.ForeignKey(Teams, on_delete=models.DO_NOTHING, related_name="home_tournament")
    away = models.ForeignKey(Teams, on_delete=models.DO_NOTHING, related_name="away_tournament")
